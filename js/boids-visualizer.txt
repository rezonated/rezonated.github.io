...
export function initScene(container, sceneType, ui) {
    ...
    // Attach UI elements to the relative parent for correct positioning
    const parentContainer = container.parentElement;
    parentContainer.appendChild(ui.uiPanel);
    parentContainer.appendChild(ui.overlay);
        ...
        for (const mutation of mutationsList) {
            if (mutation.removedNodes) {
                mutation.removedNodes.forEach((node) => {
                    // Check if the main wrapper for the diagram has been removed
    ...
    // Observe the parent of the main diagram wrapper for removal
    observer.observe(container.parentElement.parentElement, { childList: true });
    animate();
}

// =============================================================================
// --- ALL 3D SCENE SETUP FUNCTIONS (RESTORED AND VERIFIED)                  ---
// =============================================================================
...
function setupBoidsRulesScene(scene, camera, controls, container, ui) {
    ...
    const boids = Array.from({ length: 75 }, (_, i) => new Boid(i, BOUNDS));
...
// =================================================================================
// --- REVISED VISUALIZATION #4: AoS vs SoA "Memory Fetch Race"                  ---
// =================================================================================
...
// =================================================================================
// --- REVISED VISUALIZATION #5: Parallelism with SoA                             ---
// =================================================================================
